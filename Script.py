class script(object):
    START_TXT = """<b>𝖧𝖾𝗒 {}, 𝖨 𝖺𝗆 𝖺 𝖠𝗎𝗍𝗈𝖿𝗂𝗅𝗍𝖾𝗋 𝖡𝗈𝗍 𝖮𝖿𝖿𝗂𝖼𝗂𝖺𝗅𝗅𝗒 𝖬𝖺𝖽𝖾 𝖡𝗒 𝖳𝖾𝖺𝗆 𝖢𝗂𝗇𝖾𝗆𝖺𝖺𝖳𝗁𝖺𝗍𝖺𝗄𝖺𝗆. 𝖩𝗎𝗌𝗍 𝖲𝖾𝗇𝖽 𝖬𝖾 𝖬𝗈𝗏𝗂𝖾/𝖲𝖾𝗋𝗂𝖾𝗌 𝖭𝖺𝗆𝖾 𝖧𝖾𝗋𝖾 𝖺𝗇𝖽 𝖲𝖾𝖾 𝖬𝖺𝗀𝗂𝖼!</b></b>
"""
    HELP_TXT = """ʜᴇʏ {}
ʜᴇʀᴇ ɪs ᴍʏ ʜᴇʟᴘ ᴄᴏᴍᴍᴀɴᴅs."""
    ABOUT_TXT = """○ 𝖬𝗒 𝖭𝖺𝗆e : 𝖢𝖳𝖥𝗂𝗅𝗍𝖾𝗋𝖡𝗈𝗍
